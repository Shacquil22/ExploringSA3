...
public class FeaturedAdapter extends RecyclerView.Adapter<FeaturedAdapter.FeaturedViewHolder> {
    ...
    static ArrayList<FeaturedHelperClass> featuredLocations;
    ...
    public void onBindViewHolder(@NonNull FeaturedViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.rate.setRating((float) featuredHelperClass.getRating());

        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(v.getContext(), Maps.class);
                i.putExtra("title", featuredLocations.get(position).getTitle());
    ...
    public static class FeaturedViewHolder extends RecyclerView.ViewHolder{
        ...
        public FeaturedViewHolder(@NonNull View itemView) {
            ...
            title = itemView.findViewById(R.id.txtCity);
            rate = itemView.findViewById(R.id.rbCity);
